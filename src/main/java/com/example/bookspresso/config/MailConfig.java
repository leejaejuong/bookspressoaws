...
//    private static final String MAIL_SMTP_CONNECTION = "mail.smtp.connection";
//    private static final String MAIL_STARTTLS_ENABLE = "mail.starttls.enable";
//    private static final String MAIL_SMTP_DEBUG = "mail.smtp.debug";
    ...
    // 포트번호(GMAIL은 TLS 사용시 포트번호가 587 사용됨)
    // TLS(Transport Layer Security) : 네트워크 통신 보안
