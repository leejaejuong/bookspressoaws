 ...
 * form내부에 있는 input:hidden #isbn13에 isbn을 삽입한다.
 *
...
function selectBook(target) {
    ...
    const isbn13 = target.dataset.isbn13
    ...
    document.querySelector('#isbn13').value = isbn13.trim();
    ...
    list.forEach(book => {
        ...
        <li class="modal__item">
            ...
            <div class="item__select-btn-box">
                <button type="button" onclick="selectBook(this)" data-isbn13="${book.isbn13}">선택</button>
            </div>
        </li>
        `
    })
